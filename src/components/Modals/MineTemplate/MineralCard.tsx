    ...
    return (
        <div className="col-span-12 relative bg-[#3c3f50] rounded-lg md:col-span-6 lg:col-span-4 xl:col-span-3 p-4 flex flex-col gap-3">
            ...
            <button
                ...
                className={`w-full hover:opacity-75 duration-300 py-2 test text-white rounded ${progress > 0 || isMining ? "opacity-50 cursor-not-allowed" : ""}`} onClick={() => handleAddMiningExperience(mineral.experience, mineral.delay)}>Mine
            </button>
        </div>
    )
}
